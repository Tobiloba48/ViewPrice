    ...
    <div className="w-full flex flex-col" style={{ fontFamily: "'DM Sans', sans-serif" }}>
      ...
      >
        <div className="grid grid-cols-2 gap-2">
          ...
          <div>
            <p style={{ fontSize: 10, fontWeight: 600, letterSpacing: '0.06em', textTransform: 'uppercase', color: '#888780', marginBottom: 3 }}>
              {brandName}
            </p>
            <h1 style={{ fontWeight: 700, fontSize: 14, lineHeight: 1.3, marginBottom: 6, color: '#111110' }}>
              {productName}
            </h1>

            <div className="flex items-center gap-1.5">
              <img src={Star} alt="rating" style={{ width: 14, height: 14 }} />
              <span style={{ fontSize: 12, borderRight: '1px solid rgba(0,0,0,0.15)', paddingRight: 8, color: '#3a3a38' }}>
                {rating}
              </span>
              <span
                style={{
          ...
          <div className="flex justify-end items-center">
            <button
              ...
              onMouseEnter={e => { e.currentTarget.style.background = '#d94f00'; e.currentTarget.style.transform = 'scale(1.1)'; }}
              onMouseLeave={e => { e.currentTarget.style.background = '#F75D02'; e.currentTarget.style.transform = 'scale(1)'; }}
            >
          ...
          <div className="col-span-2 flex items-baseline gap-2 pt-1">
            ...
            <p style={{ textDecoration: 'line-through', fontSize: 11, color: '#888780', fontWeight: 500 }}>
              N{formalPrice}
            </p>
          </div>
