      ...
      >
        ...
        <div style={{ textAlign: 'center' }}>
          ...
          <p style={{ fontSize: 14, color: '#888780' }}>
            ...
            <Link to="/login" style={{ color: '#F75D02', fontWeight: 600, textDecoration: 'none' }}>
              Sign in
            </Link>
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          {/* Confirm Password */}
          <div style={{ display: 'flex', flexDirection: 'column', gap: 6, position: 'relative' }}>
            <label style={{ fontSize: 13, fontWeight: 500, color: '#3a3a38' }}>Confirm Password</label>
            <input
              type={showConfirm ? 'text' : 'password'}
              placeholder="Confirm Password"
              value={confirmPassword}
              onChange={handleConfirmChange}
              style={{ ...inputStyle(!passwordMatch), paddingRight: 56 }}
              onFocus={e => { e.target.style.boxShadow = `0 0 0 3px ${passwordMatch ? 'rgba(247,93,2,0.1)' : 'rgba(198,40,40,0.1)'}` ; }}
            ...
            <button
              ...
              style={{
                position: 'absolute', right: 12, bottom: passwordMatch ? 11 : 31,
                background: 'none', border: 'none', cursor: 'pointer',
                fontSize: 12, fontWeight: 600, color: '#888780',
                fontFamily: "'DM Sans', sans-serif",
              }}
          ...
          to="/confirm-email"
            ...
            style={{
              background: passwordMatch ? '#F75D02' : '#e0dbd7',
              color: '#fff',
              border: 'none',
              borderRadius: 8,
              padding: '12px 0',
            ...
            onMouseEnter={e => { if (passwordMatch) e.currentTarget.style.background = '#d94f00'; }}
        ...
        {/* Terms */}
        <p style={{ fontSize: 13, color: '#888780', textAlign: 'center', marginTop: -4 }}>
          By creating an account, you agree to our{' '}
          <a href="#" style={{ color: '#F75D02', fontWeight: 600, textDecoration: 'none' }}>
            Terms of Service
          </a>
        </p>
